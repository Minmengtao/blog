...
import com.mmt.blog.dao.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "minmengtao@163.com";
    public static final String yourName = "daydaydream";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "沪ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2021 daydaydream";
